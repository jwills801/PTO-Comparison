% IN ORDER TO RUN THIS CASE
% In the simulink model: 
% 1. Add 'goto' block with label fexc1 coming from the total excitation force of the flap
% 
% During runtime:
% 1. place breakpoint at line 354 in wecSim.m (should be 'simu.loadSimMechMode()')
% 2. run wecSim
% 3. at breakpoint, run 'ptoSimInputFile' and 'ptosim.countblocks'
% 4. continue wecSim
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
body(2).geometryFile = 'geometry/base_shift.stl';     % Geometry File
...
% Rotational PTO Acutation Torque
