...
pto(1).k = 0;%3.8278e7;                                   % PTO Stiffness Coeff [Nm/rad]
pto(1).c = 0;%2.0188e7;                               % PTO Damping Coeff [Nsm/rad]
pto(1).loc = [0 0 -8.9];                        % PTO Location [m]

%mine
%pto(1).k = 3.5280e+07;                                   % PTO Stiffness Coeff [Nm/rad]
%pto(1).c = 1.8606e+07;                             % PTO Damping Coeff [Nsm/rad]
